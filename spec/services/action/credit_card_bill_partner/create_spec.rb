...
RSpec.describe Action::CreditCardBillPartner::Create, type: :model do
  ...
  let(:form_params) {
    Form::CreditCardBillPartner.new(request_params).create_params
  }
  ...
  describe '#run!' do
    ...
    it 'saves params correctly' do
      biller_partner = described_class.new(form_params).run!
