...
RSpec.describe Action::PdamOperatorCommissionSetting::Update, type: :model do
  ...
  describe 'O2OVPE-1019: #run!' do
    ...
    context 'when setting not found' do
        before do
        ...
        it 'raises error' do
            expect{ subject.run! }.to raise_error ::Exceptions::CommissionSettingNotFound
        end
    end
    ...
    context 'when successful' do
        before do
            ...
            allow(setting).to receive(:update!).and_return true
        end
