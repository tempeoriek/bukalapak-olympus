  ...
  module Pdam
    class InternalController < ApplicationController
      ...
      def create
        ...
        service = Recurrence::Pdam::CreateTransaction.new(params[:detail_id])
        result = service.run!
      ...
      def notify_balance
        ...
        service = Recurrence::Pdam::Notifier.new('olympus_recurrence_topup_deposit_pdam_payload', params[:detail_id], options)
        result = service.run!
      ...
      def notify_stop
        ...
        service = Recurrence::Pdam::Notifier.new('olympus_recurrence_unsubscribe_success_pdam_payload', params[:detail_id])
        result = service.run!
